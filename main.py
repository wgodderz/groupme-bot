...
def groupme_webhook(): # group me calls this each time
    ...
    if bot_id:
        ...
        schedule = {
            "Monday": [
                (time(8,30),  time(9,30), "Frank Jesse, 618-420-7856"), 
                (time(9,30),  time(10,30), "Finn Romeiser, 469-601-9301"), 
                (time(10,30), time(11,30), "Finn Romeiser, 469-601-9301"),
                (time(11,30),  time(12,30), "Rodney Ferguson, 913-605-5829"),
                (time(12,30), time(13,30), "Zac Neid, 402-517-7973"),
                (time(13,30), time(14,30), "Zac Neid, 402-517-7973"),
                (time(14,30), time(15,30), "Cannon Cole, 316-617-2894"),
                (time(15,30), time(16,30), "Ryan Levine, 918-902-8584"),
            ],
            "Tuesday": [
                (time(8,30),  time(9,30), "Jacob Wright, 602-689-6301"),
                (time(9,30),  time(10,30), "Hayden Coors, 720-346-0353"),
                (time(10,30), time(11,30), "Talis Sics, 913-548-5453"),
                (time(11,30), time(12,30), "Reid Saugstad, 913-820-0901"),
                (time(12,30), time(13,30), "Jackson Harrold, 913-304-9469"),
                (time(13,30), time(14,30), "Aidan Ultzsch, 316-364-0760"),
                (time(14,30), time(15,30), "Brooklyn Ruble, 913-396-3844"),
                (time(15,30), time(16,30), "Jaden Dallen, 913-206-9161"),
            ],
            "Wednesday": [
                (time(8,30), time(9,30), "Jacob Wright, 602-689-6301"),
                (time(9,30),  time(10,30), "Hayden Coors, 720-346-0353"),
                (time(10,30), time(11,30), "Cooper Kearnes, 913-228-4654"),
                (time(11,30), time(12,30), "Rodney Ferguson, 913-605-5829"),
                (time(12,30), time(13,30), "Nick Martini, 913-908-3369"),
                (time(13,30), time(14,30), "Will Morgan, 913-335-2767"),
                (time(14,30), time(15,30), "Jackson Harrold, 913-304-9469"),
            ...
            "Thursday": [
                ...
                (time(9,30),  time(10,30), "Hayden Coors, 720-346-0353"),
                (time(10,30), time(11,30), "Talis Sics, 913-548-5453"),
                (time(11,30), time(12,30), "Brooklyn Ruble, 913-396-3844"),
                (time(12,30), time(13,30), "Peyton Ryan, 316-779-5111"),
                (time(13,30), time(14,30), "Joel Suh, 913-927-7191"),
                (time(14,30), time(15,30), "Peyton Ryan, 316-779-5111"),
                (time(15,30), time(16,30), "Ryan Levine, 918-902-8584"),
            ],
            "Friday": [
                (time(8,30),  time(9,30), "Ryan Kelley, 913-433-4611"),
                (time(9,30),  time(10,30), "Brady Mandlebaum, 913-291-7442"),
                (time(10,30), time(11,30), "Jack Vanblarcom, 913-276-8017"),
                (time(11,30), time(12,30), "Ryan Kelley, 913-433-4611"),
                (time(12,30), time(13,30), "Cooper Kearnes, 913-228-4654"),
                (time(13,30), time(14,30), "Aidan Ultzsch, 316-364-0760"),
                (time(14,30), time(15,30), "Finn Romeiser, 469-601-9301"),
                (time(15,30), time(16,30), "Finn Romeiser, 469-601-9301"),
            ],
        }
