    ...
    if bot_id:
        ...
        schedule = {
            "Monday": [
                ...
                (time(11,30),  time(12,30), "Payne Elmore, 913-486-5342"),
            ...
            "Friday": [
                ...
                (time(12,30), time(13,30), "Payne Elmore, 913-486-5342"),
                (time(13,30), time(14,30), "Finn Romeiser, 469-601-9301"),
                (time(14,30), time(15,30), "Ryan Kelley, 913-433-4611"),
                (time(15,30), time(16,30), "Rodney Ferguson, 913-605-5829"),
            ],
        }
